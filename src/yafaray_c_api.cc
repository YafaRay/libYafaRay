...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->startGeometry());
}
yafaray_bool_t yafaray_endGeometry(yafaray_Interface_t *interface) //!< call after creating geometry;
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->endGeometry());
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->endObject());
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->smoothMesh(name, angle));
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->addInstance(base_object_name, obj_to_world));
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createObject(name) != nullptr);
}

yafaray_bool_t yafaray_createLight(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createLight(name) != nullptr);
}

yafaray_bool_t yafaray_createTexture(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createTexture(name) != nullptr);
}

yafaray_bool_t yafaray_createMaterial(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createMaterial(name) != nullptr);
}

yafaray_bool_t yafaray_createCamera(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createCamera(name) != nullptr);
}

yafaray_bool_t yafaray_createBackground(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createBackground(name) != nullptr);
}

yafaray_bool_t yafaray_createIntegrator(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createIntegrator(name) != nullptr);
}

yafaray_bool_t yafaray_createVolumeRegion(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createVolumeRegion(name) != nullptr);
}

yafaray_bool_t yafaray_createRenderView(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createRenderView(name) != nullptr);
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->createOutput(name, auto_delete, callback_user_data, output_putpixel_callback, output_flush_area_callback, output_flush_callback) != nullptr);
}

yafaray_bool_t yafaray_removeOutput(yafaray_Interface_t *interface, const char *name)
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->removeOutput(name));
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->setupLayersParameters());
}
...
{
	return static_cast<yafaray_bool_t>(reinterpret_cast<yafaray4::Interface *>(interface)->setInteractive(interactive));
}
...
{
	return reinterpret_cast<yafaray_Image_t *>(reinterpret_cast<yafaray4::Interface *>(interface)->createImage(name));
}
