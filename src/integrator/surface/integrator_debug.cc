...
std::pair<std::unique_ptr<SurfaceIntegrator>, ParamError> DebugIntegrator::factory(Logger &logger, RenderControl &render_control, const ParamMap &param_map, const Scene &scene)
{
