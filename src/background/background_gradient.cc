...
std::pair<std::unique_ptr<Background>, ParamError> GradientBackground::factory(Logger &logger, const Scene &scene, const std::string &name, const ParamMap &param_map)
{
