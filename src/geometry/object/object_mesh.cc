...
MeshObject::MeshObject(ParamError &param_error, const ParamMap &param_map, const SceneItems<Material> &materials) : ParentClassType_t{param_error, param_map, materials}, params_{param_error, param_map}
{
