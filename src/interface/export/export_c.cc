...
std::string ExportC::generateHeader()
{
	...
	ss << "/* LD_LIBRARY_PATH=(path to folder with libyafaray libs) gcc -o libyafaray_example_executable -ansi -I(path to folder with libyafaray includes) -L(path to folder with libyafaray libs) (yafaray_scene_exported_source_file_name.c) -lyafaray4 */\n";
...
std::string ExportC::generateMain() const
{
	...
	ss << "\t" << "yafaray_setConsoleVerbosityLevel(yi, YAFARAY_LOG_LEVEL_INFO);\n\n";
