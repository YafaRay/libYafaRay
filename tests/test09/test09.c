 ...
 *
 *      test09.c : resume/multi-film scene with textures
 *      It can be used to check the basic functionality and texture formats
 *      and multi-film, multi-view and resuming functionality
...
int main()
{
	...
	yafaray_defineCamera(film_1, param_map);
	...
	yafaray_defineCamera(film_2, param_map);

	/* Creating image output */
	yafaray_clearParamMap(param_map);
	yafaray_setParamMapString(param_map, "image_path", "./test09-output1.tga");
	yafaray_setParamMapString(param_map, "badge_position", "top");
	yafaray_createOutput(film_1, "output_tga", param_map);
	yafaray_setParamMapString(param_map, "image_path", "./test09-output2.tga");
