...
int main()
{
	...
	yafaray_addParamMapToList(param_map_list, param_map);
		...
		yafaray_setParamMapFloat(yi, "cfactor", 0.8);
		yafaray_setParamMapString(yi, "blend_mode", "add");
		yafaray_setParamMapString(yi, "type", "mix");
	yafaray_addParamMapToList(param_map_list, param_map);
	...
	yafaray_setParamMapString(yi, "image_path", "./test08-output1.tga");
	yafaray_setParamMapString(yi, "color_space", "sRGB");
