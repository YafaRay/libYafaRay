...
{
	public:
		explicit ProgressBar(yafaray_ProgressBarCallback monitor_callback = nullptr, void *callback_data = nullptr) : progress_bar_callback_(monitor_callback), callback_data_(callback_data) { }
	...
	private:
		void updateCallback();
		yafaray_ProgressBarCallback progress_bar_callback_ = nullptr;
...
{
	public:
		explicit ConsoleProgressBar(int cwidth = 80, yafaray_ProgressBarCallback monitor_callback = nullptr, void *callback_data = nullptr);
