...
#ifndef YAFARAY_SHADER_NODE_MIX_DARK_H
#define YAFARAY_SHADER_NODE_MIX_DARK_H
...
{
	public:
		DarkNode(Logger &logger, ParamError &param_error, const ParamMap &param_map) : MixNode{logger, param_error, param_map} { }
...
#endif // YAFARAY_SHADER_NODE_MIX_DARK_H
