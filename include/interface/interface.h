...
class Interface
{
	public:
		...
		virtual void paramsSetVector(const std::string &name, Vec3f &&v) noexcept;
		virtual void paramsSetString(const std::string &name, std::string &&s) noexcept;
		virtual void paramsSetBool(const std::string &name, bool b) noexcept;
		virtual void paramsSetInt(const std::string &name, int i) noexcept;
		virtual void paramsSetFloat(const std::string &name, double f) noexcept;
		virtual void paramsSetColor(const std::string &name, Rgba &&col) noexcept;
		void paramsSetColor(const std::string &name, Rgb &&col) noexcept { paramsSetColor(std::move(name), std::move(Rgba{col})); };
		virtual void paramsSetMatrix(const std::string &name, Matrix4f &&matrix, bool transpose) noexcept;
		void paramsSetMatrix(const std::string &name, Matrix4f &&matrix) noexcept { paramsSetMatrix(std::move(name), std::move(matrix), false); };
		...
		std::pair<size_t, ResultFlags> getImageId(const std::string &name) noexcept;
		std::pair<size_t, ResultFlags> getObjectId(const std::string &name) noexcept;
		std::pair<size_t, ResultFlags> getMaterialId(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createObject(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createLight(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createTexture(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createMaterial(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createCamera(const std::string &name) noexcept;
		...
		virtual std::pair<size_t, ParamResult> createVolumeRegion(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createRenderView(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createImage(const std::string &name) noexcept;
		virtual std::pair<size_t, ParamResult> createOutput(const std::string &name) noexcept;
		...
		bool removeOutput(const std::string &name) noexcept;
