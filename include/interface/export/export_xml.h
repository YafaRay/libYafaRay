...
{
	public:
		explicit ExportXml(const char *fname, ::yafaray_LoggerCallback logger_callback = nullptr, void *callback_data = nullptr, ::yafaray_DisplayConsole logger_display_console = YAFARAY_DISPLAY_CONSOLE_NORMAL);
	...
	protected:
		...
		static void writeMatrix(const std::string &name, const Matrix4f &m, std::ofstream &file) noexcept;
