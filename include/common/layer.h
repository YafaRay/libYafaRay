...
class Layer final
{
	public:
		Layer() = default;
		explicit Layer(LayerDef::Type type, Image::Type image_type = Image::Type{Image::Type::None}, Image::Type exported_image_type =Image::Type{Image::Type::None}, std::string exported_image_name = "") : type_(type), image_type_(image_type), exported_image_type_(exported_image_type), exported_image_name_(std::move(exported_image_name)) { }
