...
class NodeMaterial: public Material
{
	public:
		...
		explicit NodeMaterial(Logger &logger, ParamResult &param_result, const ParamMap &param_map, const SceneItems <Material> &materials) : Material{logger, param_result, param_map, materials} { }
