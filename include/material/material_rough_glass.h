...
class RoughGlassMaterial final : public NodeMaterial
{
	...
	private:
		...
		Rgb eval(const MaterialData *mat_data, const SurfacePoint &sp, const Vec3 &wo, const Vec3 &wi, const BsdfFlags &bsdfs, bool force_eval = false) const override { return Rgb{0.f}; }
