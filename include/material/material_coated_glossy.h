...
{
	public:
		CoatedGlossyMaterialData(BsdfFlags bsdf_flags) : MaterialData(bsdf_flags) { }
...
class CoatedGlossyMaterial final : public NodeMaterial
{
	...
	private:
		...
		virtual std::unique_ptr<MaterialData> createMaterialData() const override { return std::unique_ptr<CoatedGlossyMaterialData>(new CoatedGlossyMaterialData(bsdf_flags_)); };
