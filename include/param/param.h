...
class ParamMap : public Collection<std::string, Parameter>
{
	public:
		...
		std::string print() const;
		std::string exportMap(yafaray_ContainerExportType container_export_type, bool only_export_non_default_parameters, const std::map<std::string, const ParamMeta *> &param_meta_map) const;
