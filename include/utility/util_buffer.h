...
#ifndef YAFARAY_UTIL_BUFFER_H
#define YAFARAY_UTIL_BUFFER_H

#include "constants.h"
BEGIN_YAFARAY

template<typename T1, unsigned char T2>
class /*YAFARAYCORE_EXPORT*/ GBuf final // no need to export this...not instantiated in yafraycore even
{
	public :
		GBuf(int x, int y)
		{
