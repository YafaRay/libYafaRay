...
class AcceleratorKdTreeMultiThread final : public Accelerator
{
	...
	private:
		...
		static SplitCostMultiThread minimalCost(float e_bonus, float cost_ratio, const Bound &node_bound, const std::vector<uint32_t> &indices, const std::vector<Bound> &bounds, bool do_poly_clipping);
