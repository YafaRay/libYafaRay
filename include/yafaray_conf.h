...
typedef void (*yafaray4_ProgressBarCallback_t)(int steps_total, int steps_done, const char *tag, void *callback_user_data);
...
typedef enum { YAFARAY_DISPLAY_CONSOLE_HIDDEN, YAFARAY_DISPLAY_CONSOLE_NORMAL } yafaray4_DisplayConsole_t;
