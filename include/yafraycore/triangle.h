...
class YAFRAYCORE_EXPORT triangle_t
{
	...
	public:
		...
		inline bool intersect(const ray_t &ray, PFLOAT *t, intersectData_t &data) const;
		...
		void getSurface(surfacePoint_t &sp, const point3d_t &hit, intersectData_t &data) const;
