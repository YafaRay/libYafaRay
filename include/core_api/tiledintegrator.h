...
#ifndef YAFARAY_TILEDINTEGRATOR_H
#define YAFARAY_TILEDINTEGRATOR_H
...
class YAFRAYCORE_EXPORT TiledIntegrator: public SurfaceIntegrator
{
	public:
...
#endif // YAFARAY_TILEDINTEGRATOR_H
