...
class YAFRAYCORE_EXPORT ExtPass  //Render pass to be exported, for example, to Blender, and mapping to the internal YafaRay render passes generated in different points of the rendering process
{
	public:
...
class YAFRAYCORE_EXPORT AuxPass  //Render pass to be used internally only, without exporting to images/Blender and mapping to the internal YafaRay render passes generated in different points of the rendering process
{
	public:
...
class YAFRAYCORE_EXPORT RenderPasses
{
...
class YAFRAYCORE_EXPORT ColorPasses  //Internal YafaRay color passes generated in different points of the rendering process
{
	public:
