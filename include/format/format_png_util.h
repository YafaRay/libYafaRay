...
inline void PngDataReader::readFromMem(png_structp png_ptr, png_bytep buffer, png_size_t bytes_to_read) // NOLINT(readability-convert-member-functions-to-static)
{
