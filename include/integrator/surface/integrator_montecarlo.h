...
class MonteCarloIntegrator: public TiledIntegrator
{
	...
	protected:
		...
		Rgb glossy(RenderData &render_data, float &alpha, const Ray &ray, const SpDifferentials &sp_diff, const Material *material, const BsdfFlags &mat_bsdfs, const BsdfFlags &bsdfs, const Vec3 &wo, float ray_min_dist, int additional_depth, ColorLayers *color_layers) const;
		Rgb specularReflect(RenderData &render_data, float &alpha, const Ray &ray, const SpDifferentials &sp_diff, const Material *material, const BsdfFlags &bsdfs, const DirectionColor *reflect_data, float ray_min_dist, int additional_depth, ColorLayers *color_layers) const;
		Rgb specularRefract(RenderData &render_data, float &alpha, const Ray &ray, const SpDifferentials &sp_diff, const Material *material, const BsdfFlags &bsdfs, const DirectionColor *refract_data, float ray_min_dist, int additional_depth, ColorLayers *color_layers) const;
