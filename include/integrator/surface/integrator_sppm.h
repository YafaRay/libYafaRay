...
class SppmIntegrator final : public MonteCarloIntegrator
{
	...
	private:
		...
		GatherInfo traceGatherRay(int thread_id, int ray_level, RenderData &render_data, const Ray &ray, HitPoint &hp, const RayDivision &ray_division, ColorLayers *color_layers, const Camera *camera);
