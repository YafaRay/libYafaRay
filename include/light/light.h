...
class Light
{
	public:
		...
		[[nodiscard]] virtual bool illumSample(const Point3 &surface_p, LSample &s, Ray &wi, float time) const = 0;
		...
		[[nodiscard]] virtual bool illuminate(const Point3 &surface_p, Rgb &col, Ray &wi) const = 0;
