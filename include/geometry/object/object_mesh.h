...
class MeshObject : public Object
{
	...
	public:
		...
		MeshObject(ParamResult &param_result, const ParamMap &param_map, const SceneItems <Object> &objects, const SceneItems<Material> &materials, const SceneItems<Light> &lights);
		~MeshObject() override;
