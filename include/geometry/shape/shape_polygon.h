...
class ShapePolygon final
{
	...
	public:
		...
		Point<T, 3> &operator[](size_t vertex_number) { return vertices_[vertex_number]; }
		const Point<T, 3> &operator[](size_t vertex_number) const { return vertices_[vertex_number]; }
