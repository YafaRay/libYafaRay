...
class TrianglePrimitive final : public FacePrimitive
{
	...
	private:
		...
		virtual SurfacePoint getSurface(const RayDifferentials *ray_differentials, const Point3 &hit_point, const IntersectData &intersect_data, const Matrix4 *obj_to_world, const Camera *camera) const override;
