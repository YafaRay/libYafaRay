...
class BsTrianglePrimitive final : public FacePrimitive
{
	...
	private:
		...
		virtual SurfacePoint getSurface(const Point3 &hit, const IntersectData &intersect_data, const Matrix4 *obj_to_world, const yafaray::Camera *camera) const override;
};
