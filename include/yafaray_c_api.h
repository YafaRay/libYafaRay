...
extern "C" {
	...
	YAFARAY_C_API_EXPORT yafaray_bool_t yafaray_addFaceWithUv(yafaray_Interface_t *interface, int a, int b, int c, int uv_a, int uv_b, int uv_c);
	...
	YAFARAY_C_API_EXPORT void yafaray_paramsSetMatrix(yafaray_Interface_t *interface, const char *name, const float m[4][4], yafaray_bool_t transpose);
