...
class Rgb
{
	public:
		...
		static LIBYAFARAY_EXPORT ColorSpace colorSpaceFromName(const std::string &color_space_name, const ColorSpace &default_color_space = ColorSpace::RawManualGamma);
