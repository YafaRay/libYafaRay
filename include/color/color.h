...
class Rgba final : public Rgb
{
	public:
		...
		float colorDifference(const Rgba &color_2, bool use_rg_bcomponents = false) const;
...
inline float Rgba::colorDifference(const Rgba &color_2, bool use_rg_bcomponents) const
{
